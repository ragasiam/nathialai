	...
	<div class="qt-parentcontainer">
		...
		<nav class="qt-menubar nav-wrapper qt-content-primary ">
			...
			<ul class="qt-desktopmenu hide-on-xl-and-down">
				<li class="qt-logo-link"><a href="./" class="brand-logo qt-logo-text">ரகசியம் <span> வானொலி</span></a></li>
			...
			<ul class="qt-desktopmenu hide-on-xl-only ">
				...
				<li><a href="#!" class="brand-logo qt-logo-text">ரகசியம் வானொலி</a></li>
			</ul>
		</nav>
		<!-- mobile menu -->
									...
									<div class="qt-vi">
										<h3 class="qt-title">
											<a href="#read" class="qt-text-shadow">
												பிரபஞ்சத்தின் தாய் மடியில், <br /><br /> புது இசை மழலையாய் <br /><br /> உங்கள் ரகசியம் வானொலி.
											</a>
										</h3>
										<div class="qt-the-content qt-spacer-s small hide-on-med-and-down ">
											<p class="qt-spacer-s qt-text-shadow">
												இசை மழையில் நனைந்திட இணைந்திருங்கள் <br /> ரகசியம் ரேடியோவுடன்...
											</p>
					...
					<div class="qt-item-header">
						...
						<div class="qt-header-mid qt-vc">
							<div class="qt-vi">
								...
								<h2 class="qt-title">
							<a href="#read" class="qt-text-shadow">
								பிரபஞ்சத்தின் தாய் மடியில், புது இசை மழலையாய் உங்கள் ரகசியம் வானொலி.
							</a>
						</h2>
								<div class="qt-the-content qt-spacer-s small hide-on-med-and-down ">
									<p class="qt-spacer-s qt-text-shadow">
										இசை மழையில் நனைந்திட இணைந்திருங்கள் ரகசியம் ரேடியோவுடன்...
									</p>
									<p><a href="#read" class="qt-btn qt-btn-l qt-btn-primary "><i class="dripicons-align-justify"></i></a></p>
								</div>
							</div>
		...
		<div class="qt-footer qt-footerwidgets">
			<div class="qt-section qt-footer-widgets qt-content-primary-light">
				<div class="qt-container">
					<h2 class="qt-footer-logo"><a href="./" class="brand-logo qt-logo-text">ரகசியம் வானொலி<span>2</span></a></h2>
						...
						<div class="col s12 m3 l3">
							<div class="qt-widget">
								...
								<div class="qt-widget-contacts">
									<p>
										<i class="qticon-home"></i><a href="http://fm.ragasiam.com">fm.ragasiam.com.com</a>
									</p>
									<p>
										<i class="qticon-at-sign"></i><a href="mailto:contact.ragasiam.com">contact.ragasiam.com</a>
									</p>
									<p>
							...
							<div class="qt-widget">
								...
								<div class="qt-widget-about">
									<p>
										...
										<br>
										<a href="http://www.ragasiam.com">Discover more <i class="dripicons-arrow-thin-right"></i></a>
									</p>
								</div>
							</div>
						</div>
						<div class="col s12 m3 l3">
							<div class="qt-widget">
								...
								<ul class="qt-widget-menu qt-list-chevron">
									<li>
										<a href="http://www.ragasiam.com">Home page</a>
									</li>
									<li>
										<a href="http://onair.ragasiam.com">Shows schedule</a>
									</li>
									<li>
										<a href="http://radio.ragasiam.com">Events archive</a>
									</li>
									<li>
										<a href="http://contact.ragasiam.com">Contacts</a>
									</li>
								</ul>
							</div>
						</div>
				...
				<div class="qt-container">
					<div class="row">
						<div class="col s12 m12 l8">
							Copyright 2018 <a href="http://www.ragasiam.com">fm.ragasiam.com</a> | Worl No1 Radio Station
		...
		<div id="channelslist" class="side-nav qt-content-primary qt-right-sidebar">
			...
			<div id="qtplayercontainer" data-playervolume="true" data-accentcolor="#dd0e34" data-accentcolordark="#ff0442" data-textcolor="#ffffff" data-soundmanagerurl="./components/soundmanager/swf/" class="qt-playercontainer qt-playervolume qt-clearfix qt-content-primary">
				<div class="qt-playercontainer-content qt-vertical-padding-m">
					<div class="qt-playercontainer-header">
						<h3 id="qtradiotitle" class="qt-text-shadow">ரகசியம் வானொலி</h3>
					</div>
					<div class="qt-playercontainer-musicplayer" id="qtmusicplayer">
						<div class="qt-musicplayer">
							<div class="ui360 ui360-vis qt-ui360">
								<a id="playerlink" href="http://109.74.196.48:8251/stream"></a>
							</div>
						</div>
					</div>
					<div class="qt-playercontainer-data qt-container qt-text-shadow small">
						<h6 class="qt-inline-textdeco">
							<span>கேட்டுக்கொண்டிருக்கும் பாடல்</span>
					</h6>
					<div class="qt-t qt-current-track"> 
					<p class="marquee">
					<span class="cc_streaminfo" data-type="song" data-username="ragasiamfm">Loading ...</span> 
					<span>   </span>
					<span> இசை மழையில் நனைந்திட இணைந்திருங்கள்...  </span>
					<span class="cc_streaminfo" data-type="song" data-username="ragasiamfm">Loading ...</span>
					</p>
						</div>
			...
			<div class="qt-part-channels-list">
				<ul class="qt-content-aside qt-channelslist qt-negative">
					<li class="qt-channel">
						<a href="#!" class="qt-ellipsis" data-title="06AM Ibiza" data-subtitle="Underground Radio" data-background="imagestemplate/photo-squared-500-500.jpg" data-logo="imagestemplate/radio-logo.png" data-playtrack="http://109.74.196.48:8251/play" data-host="109.74.196.48" data-port="8251" data-stats_path="" data-played_path="" data-channel="">
							<img src="imagestemplate/radio-logo.png" alt="logo" class="qt-radiologo dripicons-media-play" width="80" height="80">
							<i class="dripicons-media-play"></i> SD 32 kbps
						</a>
					</li>
					<li class="qt-channel">
						<a href="#!" class="qt-ellipsis" data-title="altradio" data-subtitle="The subtitle of radio 2" data-background="imagestemplate/large-1170-512.jpg" data-logo="imagestemplate/radio-logo.png" data-playtrack="http://109.74.196.48:8251/ragasiam" data-host="109.74.196.48" data-port="8251" data-stats_path="" data-played_path="" data-channel="">
							<img src="imagestemplate/radio-logo.png" alt="logo" class="qt-radiologo" width="80" height="80">
							<i class="dripicons-media-play"></i> HD 128 kbps
						</a>
					</li>
				</ul>
			</div>
